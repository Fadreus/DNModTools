...
static __stdcall void *stalker_lza_malloc(int size) {
    return(malloc(size));
}
static __stdcall void *stalker_lza_realloc(void *data, int size) {
    return(realloc(data, size));
}
static __cdecl void *stalker_lza_memset(void *data, int c, int size) {
    return(memset(data, c, size));
}
static __cdecl void *stalker_lza_memmove(void *dest, void *src, int size) {
